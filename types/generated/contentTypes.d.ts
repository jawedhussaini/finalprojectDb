...
export interface ApiCharactrasticsCharactrastics extends Schema.CollectionType {
  collectionName: 'charactrastic';
  info: {
    singularName: 'charactrastics';
    pluralName: 'charactrastic';
    displayName: 'charactrastics';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::charactrastics.charactrastics',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiClassessClassess extends Schema.CollectionType {
  collectionName: 'classes';
  info: {
    singularName: 'classess';
    pluralName: 'classes';
    displayName: 'Classes';
    description: '';
  };
  ...
  attributes: {
    ...
    charactrastics: Attribute.Relation<
      'api::classess.classess',
      'oneToMany',
      'api::charactrastics.charactrastics'
    >;
    Image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiCoachessCoachess extends Schema.CollectionType {
  collectionName: 'coaches';
  info: {
    singularName: 'coachess';
    pluralName: 'coaches';
    displayName: 'Coaches';
    description: '';
  };
  ...
  attributes: {
    Name: Attribute.String;
    Profitionalty: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::charactrastics.charactrastics': ApiCharactrasticsCharactrastics;
      'api::classess.classess': ApiClassessClassess;
